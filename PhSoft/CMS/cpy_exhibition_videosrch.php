...
$cpy_exhibition_video_search = NULL; // Initialize page object first

class ccpy_exhibition_video_search extends ccpy_exhibition_video {
	...
	// Page object name
	var $PageObjName = 'cpy_exhibition_video_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "cpy_exhibition_videolist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($cpy_exhibition_video_search)) $cpy_exhibition_video_search = new ccpy_exhibition_video_search();

// Page init
$cpy_exhibition_video_search->Page_Init();

// Page main
$cpy_exhibition_video_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_exhibition_video_search->Page_Render();
?>
...
<?php if ($cpy_exhibition_video_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fcpy_exhibition_videosearch = new ew_Form("fcpy_exhibition_videosearch", "search");
<?php } else { ?>
var CurrentForm = fcpy_exhibition_videosearch = new ew_Form("fcpy_exhibition_videosearch", "search");
<?php } ?>

// Form_CustomValidate event
fcpy_exhibition_videosearch.Form_CustomValidate = 
...
fcpy_exhibition_videosearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_exhibition_videosearch.Lists["x_exhib_id"] = {"LinkField":"x_exhib_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_exhib_title1","x_exhib_title2","x_exhib_year",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_exhibition"};
fcpy_exhibition_videosearch.Lists["x_exhib_id"].Data = "<?php echo $cpy_exhibition_video_search->exhib_id->LookupFilterQuery(FALSE, "search") ?>";
fcpy_exhibition_videosearch.Lists["x_video_id"] = {"LinkField":"x_video_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_video_title1","x_video_title2","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_video"};
fcpy_exhibition_videosearch.Lists["x_video_id"].Data = "<?php echo $cpy_exhibition_video_search->video_id->LookupFilterQuery(FALSE, "search") ?>";

// Form object for search
// Validate function for search

fcpy_exhibition_videosearch.Validate = function(fobj) {
...
<?php $cpy_exhibition_video_search->ShowPageHeader(); ?>
<?php
$cpy_exhibition_video_search->ShowMessage();
?>
<form name="fcpy_exhibition_videosearch" id="fcpy_exhibition_videosearch" class="<?php echo $cpy_exhibition_video_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_exhibition_video_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_exhibition_video_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_exhibition_video">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($cpy_exhibition_video_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($cpy_exhibition_video->exhib_id->Visible) { // exhib_id ?>
	<div id="r_exhib_id" class="form-group">
		<label for="x_exhib_id" class="<?php echo $cpy_exhibition_video_search->LeftColumnClass ?>"><span id="elh_cpy_exhibition_video_exhib_id"><?php echo $cpy_exhibition_video->exhib_id->FldCaption() ?></span>
		...
		<div class="<?php echo $cpy_exhibition_video_search->RightColumnClass ?>"><div<?php echo $cpy_exhibition_video->exhib_id->CellAttributes() ?>>
...
<?php if ($cpy_exhibition_video->video_id->Visible) { // video_id ?>
	<div id="r_video_id" class="form-group">
		<label for="x_video_id" class="<?php echo $cpy_exhibition_video_search->LeftColumnClass ?>"><span id="elh_cpy_exhibition_video_video_id"><?php echo $cpy_exhibition_video->video_id->FldCaption() ?></span>
		...
		<div class="<?php echo $cpy_exhibition_video_search->RightColumnClass ?>"><div<?php echo $cpy_exhibition_video->video_id->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_exhibition_video_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fcpy_exhibition_videosearch.Init();
</script>
<?php
$cpy_exhibition_video_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_exhibition_video_search->Page_Terminate();
?>
