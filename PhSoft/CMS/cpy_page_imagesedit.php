...
$cpy_page_images_edit = NULL; // Initialize page object first

class ccpy_page_images_edit extends ccpy_page_images {
	...
	// Page object name
	var $PageObjName = 'cpy_page_images_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_ipage_id")) {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("cpy_page_imageslist.php"); // Return to list page
			...
			if (!is_null($this->ipage_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->ipage_id->CurrentValue) == strval($this->Recordset->fields('ipage_id'))) {
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "cpy_page_imageslist.php")
	...
	function LoadFormValues() {
		...
		if (!$this->ipage_id->FldIsDetailKey)
			$this->ipage_id->setFormValue($objForm->GetValue("x_ipage_id"));
	}
...
// Create page object
if (!isset($cpy_page_images_edit)) $cpy_page_images_edit = new ccpy_page_images_edit();

// Page init
$cpy_page_images_edit->Page_Init();

// Page main
$cpy_page_images_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_page_images_edit->Page_Render();
?>
...
var CurrentForm = fcpy_page_imagesedit = new ew_Form("fcpy_page_imagesedit", "edit");

// Validate form
fcpy_page_imagesedit.Validate = function() {
...
fcpy_page_imagesedit.Form_CustomValidate = 
...
fcpy_page_imagesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_page_imagesedit.Lists["x_page_id"] = {"LinkField":"x_page_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_page_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_page"};
fcpy_page_imagesedit.Lists["x_page_id"].Data = "<?php echo $cpy_page_images_edit->page_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $cpy_page_images_edit->ShowPageHeader(); ?>
<?php
$cpy_page_images_edit->ShowMessage();
?>
<?php if (!$cpy_page_images_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($cpy_page_images_edit->Pager)) $cpy_page_images_edit->Pager = new cPrevNextPager($cpy_page_images_edit->StartRec, $cpy_page_images_edit->DisplayRecs, $cpy_page_images_edit->TotalRecs, $cpy_page_images_edit->AutoHidePager) ?>
<?php if ($cpy_page_images_edit->Pager->RecordCount > 0 && $cpy_page_images_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($cpy_page_images_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $cpy_page_images_edit->PageUrl() ?>start=<?php echo $cpy_page_images_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($cpy_page_images_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $cpy_page_images_edit->PageUrl() ?>start=<?php echo $cpy_page_images_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $cpy_page_images_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($cpy_page_images_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $cpy_page_images_edit->PageUrl() ?>start=<?php echo $cpy_page_images_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($cpy_page_images_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $cpy_page_images_edit->PageUrl() ?>start=<?php echo $cpy_page_images_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $cpy_page_images_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fcpy_page_imagesedit" id="fcpy_page_imagesedit" class="<?php echo $cpy_page_images_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_page_images_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_page_images_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_page_images">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($cpy_page_images_edit->IsModal) ?>">
<?php if ($cpy_page_images->getCurrentMasterTable() == "cpy_page") { ?>
...
<?php if ($cpy_page_images->page_id->Visible) { // page_id ?>
	<div id="r_page_id" class="form-group">
		<label id="elh_cpy_page_images_page_id" for="x_page_id" class="<?php echo $cpy_page_images_edit->LeftColumnClass ?>"><?php echo $cpy_page_images->page_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_images_edit->RightColumnClass ?>"><div<?php echo $cpy_page_images->page_id->CellAttributes() ?>>
...
<input type="hidden" id="x_page_id" name="x_page_id" value="<?php echo ew_HtmlEncode($cpy_page_images->page_id->CurrentValue) ?>">
<?php } else { ?>
<span id="el_cpy_page_images_page_id">
...
<?php } ?>
<?php echo $cpy_page_images->page_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($cpy_page_images->page_order->Visible) { // page_order ?>
	<div id="r_page_order" class="form-group">
		<label id="elh_cpy_page_images_page_order" for="x_page_order" class="<?php echo $cpy_page_images_edit->LeftColumnClass ?>"><?php echo $cpy_page_images->page_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_images_edit->RightColumnClass ?>"><div<?php echo $cpy_page_images->page_order->CellAttributes() ?>>
...
<?php echo $cpy_page_images->page_order->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($cpy_page_images->page_image->Visible) { // page_image ?>
	<div id="r_page_image" class="form-group">
		<label id="elh_cpy_page_images_page_image" class="<?php echo $cpy_page_images_edit->LeftColumnClass ?>"><?php echo $cpy_page_images->page_image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_images_edit->RightColumnClass ?>"><div<?php echo $cpy_page_images->page_image->CellAttributes() ?>>
...
<span title="<?php echo $cpy_page_images->page_image->FldTitle() ? $cpy_page_images->page_image->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($cpy_page_images->page_image->ReadOnly || $cpy_page_images->page_image->Disabled) echo " hide"; ?>">
	...
	<input type="file" title=" " data-table="cpy_page_images" data-field="x_page_image" name="x_page_image" id="x_page_image"<?php echo $cpy_page_images->page_image->EditAttributes() ?>>
</span>
<input type="hidden" name="fn_x_page_image" id= "fn_x_page_image" value="<?php echo $cpy_page_images->page_image->Upload->FileName ?>">
...
<input type="hidden" name="fx_x_page_image" id= "fx_x_page_image" value="<?php echo $cpy_page_images->page_image->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x_page_image" id= "fm_x_page_image" value="<?php echo $cpy_page_images->page_image->UploadMaxFileSize ?>">
</div>
<table id="ft_x_page_image" class="table table-condensed pull-left ewUploadTable"><tbody class="files"></tbody></table>
</span>
<?php echo $cpy_page_images->page_image->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<input type="hidden" data-table="cpy_page_images" data-field="x_ipage_id" name="x_ipage_id" id="x_ipage_id" value="<?php echo ew_HtmlEncode($cpy_page_images->ipage_id->CurrentValue) ?>">
<?php if (!$cpy_page_images_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_page_images_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_page_images_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fcpy_page_imagesedit.Init();
</script>
<?php
$cpy_page_images_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_page_images_edit->Page_Terminate();
?>
