...
<?php if ($cpy_page->page_text->Visible) { // page_text ?>
	<div id="r_page_text" class="form-group">
		<label class="<?php echo $cpy_page_search->LeftColumnClass ?>"><span id="elh_cpy_page_page_text"><?php echo $cpy_page->page_text->FldCaption() ?></span>
		...
		<div class="<?php echo $cpy_page_search->RightColumnClass ?>"><div<?php echo $cpy_page->page_text->CellAttributes() ?>>
			<span id="el_cpy_page_page_text">
<input type="text" data-table="cpy_page" data-field="x_page_text" name="x_page_text" id="x_page_text" size="35" placeholder="<?php echo ew_HtmlEncode($cpy_page->page_text->getPlaceHolder()) ?>" value="<?php echo $cpy_page->page_text->EditValue ?>"<?php echo $cpy_page->page_text->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
