	...
	function RenderRow() {
		...
		$this->slid_image->ViewCustomAttributes = "";
			...
			if ($this->slid_image->UseColorbox) {
				...
				$this->slid_image->LinkAttrs["data-rel"] = "cpy_slider_trn_x_slid_image";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->slid_image);
...
<?php if ($cpy_slider_trn->slid_image->Visible) { // slid_image ?>
	<div id="r_slid_image" class="form-group">
		<label id="elh_cpy_slider_trn_slid_image" class="<?php echo $cpy_slider_trn_edit->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_slider_trn_edit->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_image->CellAttributes() ?>>
<span id="el_cpy_slider_trn_slid_image">
<div id="fd_x_slid_image">
<span title="<?php echo $cpy_slider_trn->slid_image->FldTitle() ? $cpy_slider_trn->slid_image->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($cpy_slider_trn->slid_image->ReadOnly || $cpy_slider_trn->slid_image->Disabled) echo " hide"; ?>">
	...
	<input type="file" title=" " data-table="cpy_slider_trn" data-field="x_slid_image" name="x_slid_image" id="x_slid_image"<?php echo $cpy_slider_trn->slid_image->EditAttributes() ?>>
</span>
<input type="hidden" name="fn_x_slid_image" id= "fn_x_slid_image" value="<?php echo $cpy_slider_trn->slid_image->Upload->FileName ?>">
<?php if (@$_POST["fa_x_slid_image"] == "0") { ?>
<input type="hidden" name="fa_x_slid_image" id= "fa_x_slid_image" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_slid_image" id= "fa_x_slid_image" value="1">
<?php } ?>
<input type="hidden" name="fs_x_slid_image" id= "fs_x_slid_image" value="200">
<input type="hidden" name="fx_x_slid_image" id= "fx_x_slid_image" value="<?php echo $cpy_slider_trn->slid_image->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x_slid_image" id= "fm_x_slid_image" value="<?php echo $cpy_slider_trn->slid_image->UploadMaxFileSize ?>">
</div>
<table id="ft_x_slid_image" class="table table-condensed pull-left ewUploadTable"><tbody class="files"></tbody></table>
</span>
<?php echo $cpy_slider_trn->slid_image->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
