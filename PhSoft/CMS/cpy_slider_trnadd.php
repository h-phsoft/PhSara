...
class ccpy_slider_trn_add extends ccpy_slider_trn {
	...
	function LoadDefaultValues() {
		...
		$this->slid_image->CurrentValue = NULL; // Clear file related field
	}
	...
	function RenderRow() {
		...
		$this->slid_image->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slid_image);
...
<?php if ($cpy_slider_trn->slid_image->Visible) { // slid_image ?>
	<div id="r_slid_image" class="form-group">
		<label id="elh_cpy_slider_trn_slid_image" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_image->CellAttributes() ?>>
