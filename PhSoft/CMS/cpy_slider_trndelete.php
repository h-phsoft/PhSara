...
<?php if ($cpy_slider_trn->slid_image->Visible) { // slid_image ?>
		<th class="<?php echo $cpy_slider_trn->slid_image->HeaderCellClass() ?>"><span id="elh_cpy_slider_trn_slid_image" class="cpy_slider_trn_slid_image"><?php echo $cpy_slider_trn->slid_image->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($cpy_slider_trn->slid_image->Visible) { // slid_image ?>
		<td<?php echo $cpy_slider_trn->slid_image->CellAttributes() ?>>
<span id="el<?php echo $cpy_slider_trn_delete->RowCnt ?>_cpy_slider_trn_slid_image" class="cpy_slider_trn_slid_image">
<span>
