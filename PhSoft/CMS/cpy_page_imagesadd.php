...
$cpy_page_images_add = NULL; // Initialize page object first

class ccpy_page_images_add extends ccpy_page_images {
	...
	// Page object name
	var $PageObjName = 'cpy_page_images_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("cpy_page_imageslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cpy_page_imagesview.php")
...
// Create page object
if (!isset($cpy_page_images_add)) $cpy_page_images_add = new ccpy_page_images_add();

// Page init
$cpy_page_images_add->Page_Init();

// Page main
$cpy_page_images_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_page_images_add->Page_Render();
?>
...
var CurrentForm = fcpy_page_imagesadd = new ew_Form("fcpy_page_imagesadd", "add");

// Validate form
fcpy_page_imagesadd.Validate = function() {
...
fcpy_page_imagesadd.Form_CustomValidate = 
...
fcpy_page_imagesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_page_imagesadd.Lists["x_page_id"] = {"LinkField":"x_page_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_page_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_page"};
fcpy_page_imagesadd.Lists["x_page_id"].Data = "<?php echo $cpy_page_images_add->page_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $cpy_page_images_add->ShowPageHeader(); ?>
<?php
$cpy_page_images_add->ShowMessage();
?>
<form name="fcpy_page_imagesadd" id="fcpy_page_imagesadd" class="<?php echo $cpy_page_images_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_page_images_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_page_images_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_page_images">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cpy_page_images_add->IsModal) ?>">
...
<?php if ($cpy_page_images->page_id->Visible) { // page_id ?>
	<div id="r_page_id" class="form-group">
		<label id="elh_cpy_page_images_page_id" for="x_page_id" class="<?php echo $cpy_page_images_add->LeftColumnClass ?>"><?php echo $cpy_page_images->page_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_images_add->RightColumnClass ?>"><div<?php echo $cpy_page_images->page_id->CellAttributes() ?>>
...
<?php if ($cpy_page_images->page_order->Visible) { // page_order ?>
	<div id="r_page_order" class="form-group">
		<label id="elh_cpy_page_images_page_order" for="x_page_order" class="<?php echo $cpy_page_images_add->LeftColumnClass ?>"><?php echo $cpy_page_images->page_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_images_add->RightColumnClass ?>"><div<?php echo $cpy_page_images->page_order->CellAttributes() ?>>
...
<?php if ($cpy_page_images->page_image->Visible) { // page_image ?>
	<div id="r_page_image" class="form-group">
		<label id="elh_cpy_page_images_page_image" class="<?php echo $cpy_page_images_add->LeftColumnClass ?>"><?php echo $cpy_page_images->page_image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_page_images_add->RightColumnClass ?>"><div<?php echo $cpy_page_images->page_image->CellAttributes() ?>>
...
<?php if (!$cpy_page_images_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_page_images_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_page_images_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcpy_page_imagesadd.Init();
</script>
<?php
$cpy_page_images_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_page_images_add->Page_Terminate();
?>
