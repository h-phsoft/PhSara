...
$cpy_exhibition_images_add = NULL; // Initialize page object first

class ccpy_exhibition_images_add extends ccpy_exhibition_images {
	...
	// Page object name
	var $PageObjName = 'cpy_exhibition_images_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("cpy_exhibition_imageslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cpy_exhibition_imagesview.php")
...
// Create page object
if (!isset($cpy_exhibition_images_add)) $cpy_exhibition_images_add = new ccpy_exhibition_images_add();

// Page init
$cpy_exhibition_images_add->Page_Init();

// Page main
$cpy_exhibition_images_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_exhibition_images_add->Page_Render();
?>
...
var CurrentForm = fcpy_exhibition_imagesadd = new ew_Form("fcpy_exhibition_imagesadd", "add");

// Validate form
fcpy_exhibition_imagesadd.Validate = function() {
...
fcpy_exhibition_imagesadd.Form_CustomValidate = 
...
fcpy_exhibition_imagesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_exhibition_imagesadd.Lists["x_exhib_id"] = {"LinkField":"x_exhib_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_exhib_title1","x_exhib_title2","x_exhib_year",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_exhibition"};
fcpy_exhibition_imagesadd.Lists["x_exhib_id"].Data = "<?php echo $cpy_exhibition_images_add->exhib_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $cpy_exhibition_images_add->ShowPageHeader(); ?>
<?php
$cpy_exhibition_images_add->ShowMessage();
?>
<form name="fcpy_exhibition_imagesadd" id="fcpy_exhibition_imagesadd" class="<?php echo $cpy_exhibition_images_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_exhibition_images_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_exhibition_images_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_exhibition_images">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cpy_exhibition_images_add->IsModal) ?>">
...
<?php if ($cpy_exhibition_images->exhib_id->Visible) { // exhib_id ?>
	<div id="r_exhib_id" class="form-group">
		<label id="elh_cpy_exhibition_images_exhib_id" for="x_exhib_id" class="<?php echo $cpy_exhibition_images_add->LeftColumnClass ?>"><?php echo $cpy_exhibition_images->exhib_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_exhibition_images_add->RightColumnClass ?>"><div<?php echo $cpy_exhibition_images->exhib_id->CellAttributes() ?>>
...
<?php if ($cpy_exhibition_images->exhib_order->Visible) { // exhib_order ?>
	<div id="r_exhib_order" class="form-group">
		<label id="elh_cpy_exhibition_images_exhib_order" for="x_exhib_order" class="<?php echo $cpy_exhibition_images_add->LeftColumnClass ?>"><?php echo $cpy_exhibition_images->exhib_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_exhibition_images_add->RightColumnClass ?>"><div<?php echo $cpy_exhibition_images->exhib_order->CellAttributes() ?>>
...
<?php if ($cpy_exhibition_images->exhib_image->Visible) { // exhib_image ?>
	<div id="r_exhib_image" class="form-group">
		<label id="elh_cpy_exhibition_images_exhib_image" class="<?php echo $cpy_exhibition_images_add->LeftColumnClass ?>"><?php echo $cpy_exhibition_images->exhib_image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_exhibition_images_add->RightColumnClass ?>"><div<?php echo $cpy_exhibition_images->exhib_image->CellAttributes() ?>>
...
<?php if (!$cpy_exhibition_images_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_exhibition_images_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_exhibition_images_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcpy_exhibition_imagesadd.Init();
</script>
<?php
$cpy_exhibition_images_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_exhibition_images_add->Page_Terminate();
?>
