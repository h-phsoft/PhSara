...
$cpy_exhibition_video_grid = NULL; // Initialize page object first

class ccpy_exhibition_video_grid extends ccpy_exhibition_video {
	...
	// Page object name
	var $PageObjName = 'cpy_exhibition_video_grid';

	// Grid form hidden field names
	var $FormName = 'fcpy_exhibition_videogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cpy_exhibition_video"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->vexhib_id->CurrentValue = strval($arKeys[0]); // vexhib_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
