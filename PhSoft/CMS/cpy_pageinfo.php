...
class ccpy_page extends cTable {
	...
	function __construct() {
		...
		// page_text
		$this->page_text = new cField('cpy_page', 'cpy_page', 'x_page_text', 'page_text', '`page_text`', '`page_text`', 201, -1, FALSE, '`page_text`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "cpy_page_images") {
			$sDetailUrl = $GLOBALS["cpy_page_images"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
