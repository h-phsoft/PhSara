...
$cpy_artwork_exhibtion_grid = NULL; // Initialize page object first

class ccpy_artwork_exhibtion_grid extends ccpy_artwork_exhibtion {
	...
	// Page object name
	var $PageObjName = 'cpy_artwork_exhibtion_grid';

	// Grid form hidden field names
	var $FormName = 'fcpy_artwork_exhibtiongrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cpy_artwork_exhibtion"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->artexh_id->CurrentValue = strval($arKeys[0]); // artexh_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
