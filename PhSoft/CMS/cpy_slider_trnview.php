...
<?php if ($cpy_slider_trn->slid_image->Visible) { // slid_image ?>
	<tr id="r_slid_image">
		<td class="col-sm-2"><span id="elh_cpy_slider_trn_slid_image"><?php echo $cpy_slider_trn->slid_image->FldCaption() ?></span></td>
		<td data-name="slid_image"<?php echo $cpy_slider_trn->slid_image->CellAttributes() ?>>
<span id="el_cpy_slider_trn_slid_image">
<span>
<?php echo ew_GetFileViewTag($cpy_slider_trn->slid_image, $cpy_slider_trn->slid_image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
