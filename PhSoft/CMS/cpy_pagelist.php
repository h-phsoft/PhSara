...
class ccpy_page_list extends ccpy_page {
	...
	function SetupListOptions() {
		...
		$item = &$this->ListOptions->Add("detail_cpy_page_images");
		$item->CssClass = "text-nowrap";
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'cpy_page_images') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
	...
	function RenderListOptions() {
		...
		// "detail_cpy_page_images"
		$oListOpt = &$this->ListOptions->Items["detail_cpy_page_images"];
		if ($Security->AllowList(CurrentProjectID() . 'cpy_page_images')) {
			$body = $Language->Phrase("DetailLink") . $Language->TablePhrase("cpy_page_images", "TblCaption");
			...
			$links = "";
			if ($GLOBALS["cpy_page_images_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'cpy_page_images')) {
				$caption = $Language->Phrase("MasterDetailViewLink");
				$url = $this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=cpy_page_images");
			...
			if ($GLOBALS["cpy_page_images_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'cpy_page_images')) {
				$caption = $Language->Phrase("MasterDetailEditLink");
				$url = $this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=cpy_page_images");
			...
			if ($GLOBALS["cpy_page_images_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'cpy_page_images')) {
				$caption = $Language->Phrase("MasterDetailCopyLink");
				$url = $this->GetCopyUrl(EW_TABLE_SHOW_DETAIL . "=cpy_page_images");
	...
	function SetupOtherOptions() {
		...
		$DetailTableLink = "";
		$item = &$option->Add("detailadd_cpy_page_images");
		$url = $this->GetAddUrl(EW_TABLE_SHOW_DETAIL . "=cpy_page_images");
		$caption = $Language->Phrase("Add") . "&nbsp;" . $this->TableCaption() . "/" . $GLOBALS["cpy_page_images"]->TableCaption();
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["cpy_page_images"]->DetailAdd && $Security->AllowAdd(CurrentProjectID() . 'cpy_page_images') && $Security->CanAdd());
		if ($item->Visible) {
	...
	function SetupSearchOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<button type=\"button\" class=\"btn btn-default ewAdvancedSearch\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-table=\"cpy_page\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'SearchBtn',url:'cpy_pagesrch.php'});\">" . $Language->Phrase("AdvancedSearchBtn") . "</button>";
		$item->Visible = TRUE;
