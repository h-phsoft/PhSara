...
$cpy_exhibition_images_grid = NULL; // Initialize page object first

class ccpy_exhibition_images_grid extends ccpy_exhibition_images {
	...
	// Page object name
	var $PageObjName = 'cpy_exhibition_images_grid';

	// Grid form hidden field names
	var $FormName = 'fcpy_exhibition_imagesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cpy_exhibition_images"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadDefaultValues() {
		...
		$this->exhib_image->Upload->Index = $this->RowIndex;
	}
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->iexhib_id->CurrentValue = strval($arKeys[0]); // iexhib_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "cpy_exhibition") {
			$this->exhib_id->Visible = FALSE;
			if ($GLOBALS["cpy_exhibition"]->EventCancelled) $this->EventCancelled = TRUE;
		}
