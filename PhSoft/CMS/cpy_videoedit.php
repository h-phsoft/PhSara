...
class ccpy_video_edit extends ccpy_video {
	...
	function NewRow() {
		...
		$row['video_id'] = NULL;
		$row['video_date'] = NULL;
		$row['video_title1'] = NULL;
		$row['video_title2'] = NULL;
		$row['video_URL'] = NULL;
		$row['video_text'] = NULL;
		return $row;
	}
...
<?php if ($cpy_video->video_date->Visible) { // video_date ?>
	<div id="r_video_date" class="form-group">
		<label id="elh_cpy_video_video_date" for="x_video_date" class="<?php echo $cpy_video_edit->LeftColumnClass ?>"><?php echo $cpy_video->video_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_video_edit->RightColumnClass ?>"><div<?php echo $cpy_video->video_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fcpy_videoedit", "x_video_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($cpy_video->video_title1->Visible) { // video_title1 ?>
	<div id="r_video_title1" class="form-group">
		<label id="elh_cpy_video_video_title1" for="x_video_title1" class="<?php echo $cpy_video_edit->LeftColumnClass ?>"><?php echo $cpy_video->video_title1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_video_edit->RightColumnClass ?>"><div<?php echo $cpy_video->video_title1->CellAttributes() ?>>
...
<?php if ($cpy_video->video_title2->Visible) { // video_title2 ?>
	<div id="r_video_title2" class="form-group">
		<label id="elh_cpy_video_video_title2" for="x_video_title2" class="<?php echo $cpy_video_edit->LeftColumnClass ?>"><?php echo $cpy_video->video_title2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_video_edit->RightColumnClass ?>"><div<?php echo $cpy_video->video_title2->CellAttributes() ?>>
...
<?php if ($cpy_video->video_text->Visible) { // video_text ?>
	<div id="r_video_text" class="form-group">
		<label id="elh_cpy_video_video_text" for="x_video_text" class="<?php echo $cpy_video_edit->LeftColumnClass ?>"><?php echo $cpy_video->video_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_video_edit->RightColumnClass ?>"><div<?php echo $cpy_video->video_text->CellAttributes() ?>>
