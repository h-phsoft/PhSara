...
$cpy_artwork_exhibtion_edit = NULL; // Initialize page object first

class ccpy_artwork_exhibtion_edit extends ccpy_artwork_exhibtion {
	...
	// Page object name
	var $PageObjName = 'cpy_artwork_exhibtion_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_artexh_id")) {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("cpy_artwork_exhibtionlist.php"); // Return to list page
			...
			if (!is_null($this->artexh_id->CurrentValue)) {
				while (!$this->Recordset->EOF) {
					if (strval($this->artexh_id->CurrentValue) == strval($this->Recordset->fields('artexh_id'))) {
	...
	function LoadFormValues() {
		...
		if (!$this->artexh_id->FldIsDetailKey)
			$this->artexh_id->setFormValue($objForm->GetValue("x_artexh_id"));
	}
...
// Create page object
if (!isset($cpy_artwork_exhibtion_edit)) $cpy_artwork_exhibtion_edit = new ccpy_artwork_exhibtion_edit();

// Page init
$cpy_artwork_exhibtion_edit->Page_Init();

// Page main
$cpy_artwork_exhibtion_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_artwork_exhibtion_edit->Page_Render();
?>
...
var CurrentForm = fcpy_artwork_exhibtionedit = new ew_Form("fcpy_artwork_exhibtionedit", "edit");

// Validate form
fcpy_artwork_exhibtionedit.Validate = function() {
...
fcpy_artwork_exhibtionedit.Form_CustomValidate = 
...
fcpy_artwork_exhibtionedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_artwork_exhibtionedit.Lists["x_art_id"] = {"LinkField":"x_art_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_art_title1","x_art_title2","x_art_year",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_artwork"};
fcpy_artwork_exhibtionedit.Lists["x_art_id"].Data = "<?php echo $cpy_artwork_exhibtion_edit->art_id->LookupFilterQuery(FALSE, "edit") ?>";
fcpy_artwork_exhibtionedit.Lists["x_exhib_id"] = {"LinkField":"x_exhib_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_exhib_title1","x_exhib_title2","x_exhib_year",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_exhibition"};
fcpy_artwork_exhibtionedit.Lists["x_exhib_id"].Data = "<?php echo $cpy_artwork_exhibtion_edit->exhib_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $cpy_artwork_exhibtion_edit->ShowPageHeader(); ?>
<?php
$cpy_artwork_exhibtion_edit->ShowMessage();
?>
<?php if (!$cpy_artwork_exhibtion_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($cpy_artwork_exhibtion_edit->Pager)) $cpy_artwork_exhibtion_edit->Pager = new cPrevNextPager($cpy_artwork_exhibtion_edit->StartRec, $cpy_artwork_exhibtion_edit->DisplayRecs, $cpy_artwork_exhibtion_edit->TotalRecs, $cpy_artwork_exhibtion_edit->AutoHidePager) ?>
<?php if ($cpy_artwork_exhibtion_edit->Pager->RecordCount > 0 && $cpy_artwork_exhibtion_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($cpy_artwork_exhibtion_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $cpy_artwork_exhibtion_edit->PageUrl() ?>start=<?php echo $cpy_artwork_exhibtion_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($cpy_artwork_exhibtion_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $cpy_artwork_exhibtion_edit->PageUrl() ?>start=<?php echo $cpy_artwork_exhibtion_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $cpy_artwork_exhibtion_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($cpy_artwork_exhibtion_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $cpy_artwork_exhibtion_edit->PageUrl() ?>start=<?php echo $cpy_artwork_exhibtion_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($cpy_artwork_exhibtion_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $cpy_artwork_exhibtion_edit->PageUrl() ?>start=<?php echo $cpy_artwork_exhibtion_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $cpy_artwork_exhibtion_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fcpy_artwork_exhibtionedit" id="fcpy_artwork_exhibtionedit" class="<?php echo $cpy_artwork_exhibtion_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_artwork_exhibtion_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_artwork_exhibtion_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_artwork_exhibtion">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($cpy_artwork_exhibtion_edit->IsModal) ?>">
...
<?php if ($cpy_artwork_exhibtion->art_id->Visible) { // art_id ?>
	<div id="r_art_id" class="form-group">
		<label id="elh_cpy_artwork_exhibtion_art_id" for="x_art_id" class="<?php echo $cpy_artwork_exhibtion_edit->LeftColumnClass ?>"><?php echo $cpy_artwork_exhibtion->art_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_artwork_exhibtion_edit->RightColumnClass ?>"><div<?php echo $cpy_artwork_exhibtion->art_id->CellAttributes() ?>>
...
<?php if ($cpy_artwork_exhibtion->exhib_order->Visible) { // exhib_order ?>
	<div id="r_exhib_order" class="form-group">
		<label id="elh_cpy_artwork_exhibtion_exhib_order" for="x_exhib_order" class="<?php echo $cpy_artwork_exhibtion_edit->LeftColumnClass ?>"><?php echo $cpy_artwork_exhibtion->exhib_order->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_artwork_exhibtion_edit->RightColumnClass ?>"><div<?php echo $cpy_artwork_exhibtion->exhib_order->CellAttributes() ?>>
...
<?php if ($cpy_artwork_exhibtion->exhib_id->Visible) { // exhib_id ?>
	<div id="r_exhib_id" class="form-group">
		<label id="elh_cpy_artwork_exhibtion_exhib_id" for="x_exhib_id" class="<?php echo $cpy_artwork_exhibtion_edit->LeftColumnClass ?>"><?php echo $cpy_artwork_exhibtion->exhib_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_artwork_exhibtion_edit->RightColumnClass ?>"><div<?php echo $cpy_artwork_exhibtion->exhib_id->CellAttributes() ?>>
...
<input type="hidden" data-table="cpy_artwork_exhibtion" data-field="x_artexh_id" name="x_artexh_id" id="x_artexh_id" value="<?php echo ew_HtmlEncode($cpy_artwork_exhibtion->artexh_id->CurrentValue) ?>">
<?php if (!$cpy_artwork_exhibtion_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_artwork_exhibtion_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_artwork_exhibtion_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fcpy_artwork_exhibtionedit.Init();
</script>
<?php
$cpy_artwork_exhibtion_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_artwork_exhibtion_edit->Page_Terminate();
?>
