...
$cpy_page_images_grid = NULL; // Initialize page object first

class ccpy_page_images_grid extends ccpy_page_images {
	...
	// Page object name
	var $PageObjName = 'cpy_page_images_grid';

	// Grid form hidden field names
	var $FormName = 'fcpy_page_imagesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cpy_page_images"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->ipage_id->CurrentValue = strval($arKeys[0]); // ipage_id
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
