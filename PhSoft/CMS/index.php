...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'cpy_artwork'))
		$this->Page_Terminate("cpy_artworklist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'cpy_arttype'))
			$this->Page_Terminate("cpy_arttypelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_artwork_exhibtion'))
			$this->Page_Terminate("cpy_artwork_exhibtionlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_artwork_subject'))
			$this->Page_Terminate("cpy_artwork_subjectlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_bibliography'))
			$this->Page_Terminate("cpy_bibliographylist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_exhibition'))
			$this->Page_Terminate("cpy_exhibitionlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_exhibition_images'))
			$this->Page_Terminate("cpy_exhibition_imageslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_exhibition_video'))
			$this->Page_Terminate("cpy_exhibition_videolist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_exhibkind'))
			$this->Page_Terminate("cpy_exhibkindlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_exhibtype'))
			$this->Page_Terminate("cpy_exhibtypelist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'cpy_page_images'))
			$this->Page_Terminate("cpy_page_imageslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_publication'))
			$this->Page_Terminate("cpy_publicationlist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'cpy_subject'))
			$this->Page_Terminate("cpy_subjectlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_subscribe'))
			$this->Page_Terminate("cpy_subscribelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_vartwork'))
			$this->Page_Terminate("cpy_vartworklist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_vartwork_subjects'))
			$this->Page_Terminate("cpy_vartwork_subjectslist.php");
